---
public: false
title: 'Newtの設定とWebサイトでデータの取得するところまで'
...
![Newtスペースの作成](/public/asset/img/post/14_1.jpg)

すると、管理画面に入ることができました。

![Newt管理画面](/public/asset/img/post/14_2.jpg)
...
![Newt管理画面](/public/asset/img/post/14_3.jpg)
...
![Newt管理画面](/public/asset/img/post/14_4.jpg)
...
![Newt管理画面](/public/asset/img/post/14_5.jpg)

ここでも作成をクリックすると、無事トークンを発行することができました。

![Newt管理画面](/public/asset/img/post/14_6.jpg)
...
![Newt管理画面](/public/asset/img/post/14_11.jpg)
...
![Newt管理画面](/public/asset/img/post/14_12.jpg)

そこで、左側サイドバーにモデル一覧が並んでいるので、「Article」にカーソルを当てると右側に「…」が出てくるので、「モデルを設定」をクリックしてみましょう。

![Newt管理画面](/public/asset/img/post/14_13.jpg)

すると、モーダルが立ち上がり「モデル UID」を確認することができます。  
この場合は"article"となります。

![Newt管理画面](/public/asset/img/post/14_14.jpg)
...
model を作ったりしている途中で保存するのを忘れて他のページに行くときに、保存しなくて大丈夫？って聞いてもらえると、うっかり者の自分にとっては助かるなと思いました
